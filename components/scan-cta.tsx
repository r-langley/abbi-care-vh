...
export function ScanCTA() {
  return (
    <div className="bg-[#f5f6f5] flex flex-col gap-[20px] items-center justify-center p-[20px] rounded-[10px] w-full">
      <div className="flex flex-col gap-[10px] items-center w-full">
        <div className="flex items-center justify-center size-[24px]">
          <Sparkles className="size-[20px] text-[#586158]" />
        </div>
        <p className="font-semibold text-[24px] tracking-[-0.48px] text-[#586158] text-center leading-[1.35]">
          97% Accurate, 100% you
        </p>
