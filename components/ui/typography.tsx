...
export function PageTitle({ className, variant = "default", ...props }: PageTitleProps) {
  return (
    <h1
      className={cn(
        "text-balance text-foreground font-medium tracking-tight leading-7 text-3xl",
...
export function SectionHeading({ className, align = "center", spacing = "default", ...props }: SectionHeadingProps) {
  return (
    <h2
      className={cn(
        "text-2xl md:text-3xl leading-7 font-semibold text-left",
...
export function BodyText({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) {
  return <p className={cn("text-base text-foreground leading-relaxed text-left", className)} {...props} />
}
